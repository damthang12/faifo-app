...
export default function UpdatePlanModal({ isVisible, onClose, tripId }: { isVisible: boolean; onClose: () => void, tripId?: string }) {
    ...
    const { updatePlannedTrip } = useTripStore();
    ...
    const handleSubmit = () => {
        ...
        updatePlannedTrip(tripId || '',updateTrip);
        onClose();
    };
        ...
        <Modal isVisible={isVisible} onBackdropPress={onClose} style={{ justifyContent: 'flex-end', margin: 0 }} avoidKeyboard>
            <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
                <View className="bg-white p-6 rounded-t-3xl max-h-[100%]">
                    ...
                    <ScrollView>
                        <Text className="text-2xl font-bold font-beVN text-gray-900 mb-4">Cập nhật thông tin chuyến đi</Text>
                        ...
                        <View className="flex-row items-center justify-between mt-4">
                            ...
                            <Pressable className="border border-[#F99F04] p-4 rounded-full w-[48%]" onPress={() => onClose()}>
                                <Text className="text-center text-xl text-[#F99F04] font-bold">Huỷ</Text>
                            </Pressable>

                            <Pressable className="bg-[#F99F04] p-4 rounded-full w-[48%] " onPress={handleSubmit}>
                                <Text className="text-center text-xl text-white font-bold">Lưu chỉnh sửa</Text>
                            </Pressable>
                        </View>
