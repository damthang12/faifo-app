    ...
    return (
        ...
        >
            <View className="bg-white rounded-3xl p-6 flex-col gap-4 space-y-4">
                <Text className="text-2xl font-semibold font-beVNSemibold text-center">Đăng xuất tài khoản</Text>
                ...
                <View className="flex-row justify-between gap-3">
                    ...
                    >
                        <Text className="text-[#F99F04] text-xl font-beVNSemibold font-semibold">Huỷ</Text>
                    </TouchableOpacity>
                    ...
                    >
                        <Text className="text-white text-xl font-beVNSemibold font-semibold">Đăng xuất</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </Modal>
