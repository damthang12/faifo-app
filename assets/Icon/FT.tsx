    ...
    return (
        <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
            <Path
                ...
                stroke="#351904" stroke-width="2.5" stroke-miterlimit="10" stroke-linecap="round"
                stroke-linejoin="round"/>
            <Path d="M10.93 2.10001L6 10" stroke="#351904" stroke-width="2.5" stroke-miterlimit="10"
