...
export default function RemoveIcon({size = 25, color = "white"}) {
    return (
        ...
        <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
            ...
            <Path
                ...
                stroke="#252B37" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            <Path d="M10.33 16.5H13.66" stroke="#252B37" stroke-width="1.5" stroke-linecap="round"
                  stroke-linejoin="round"/>
            <Path d="M9.5 12.5H14.5" stroke="#252B37" stroke-width="1.5" stroke-linecap="round"
                  stroke-linejoin="round"/>
        </Svg>
