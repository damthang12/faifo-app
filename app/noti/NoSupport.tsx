...
export default function NotSupportSuccess() {
    ...
    return (
        <View className="flex w-full items-center bg-[#F7E9CE]  justify-center h-full px-6 gap-10">
            ...
            <View className=" w-full max-w-[348px] flex flex-col items-center justify-center gap-2">
                ...
                <Text className="text-base font-bold  font-beVNBold text-center">Hiện tại Faifo đang ngưng hỗ trợ đăng nhập bằng cách này. Bạn vui lòng thử lại giúp chúng tớ nhé.</Text>
            </View>
